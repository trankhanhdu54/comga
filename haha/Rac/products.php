...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <textarea name="chitiet" class="box" required placeholder="Nhập giới thiệu sản phẩm" maxlength="500" cols="30" rows="5" minlength="266"></textarea>
   ...
   ?>
         <option value="<?= $fetch_category['id']; ?>"><?= $fetch_category['namedanhmuc']; ?></option>
         <?php
         }
      }else{
...
<section class="show-products" style="padding-top: 0;">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Xóa sản phẩm?');">Xóa</a>
      </div>
   </div>
   <?php
         }

...
<section class="update-product">
   ...
   <?php
      ...
      $show_products = $conn->prepare("SELECT category.iddanhmuc,category.namedanhmuc, 
      products.id,products.name,products.price,products.image,products.fff,products.loaisanpham,products.chitiet 
   ...
   <div style="margin-bottom:10px;" class="flex-btn">
      ...
      <input type="number" min="0" max="9999999999" required placeholder="Nếu 100k thì chỉ cần ghi 100" name="price" onkeypress="if(this.value.length == 10) return false;" class="box" value="<?= $fetch_products['price']; ?>">
      ...
      <span>Cập nhật danh mục</span>
         <select name="category" class="box" required>
            <option selected value="<?= $fetch_products['iddanhmuc']; ?>"><?= $fetch_products['namedanhmuc']; ?></option>
            <?php

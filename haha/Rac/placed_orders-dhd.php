...
<section class="placed-orders">
   ...
   <h1 class="heading">Đơn Hàng Đã Hủy Đơn</h1>

   <div class="box-container">

   <?php
      $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE payment_status = 'Đã hủy đơn' ORDER BY id DESC");

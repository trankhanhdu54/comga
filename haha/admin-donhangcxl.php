...
<head>
    ...
    <title>Đơn Hàng Chưa Xử Lí</title>
...
<h1 class="heading">Đơn Chưa Xử Lí</h1>

<div class="box-container">

<?php
   $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE payment_status = 'Chưa xử lí' ORDER BY id DESC;");

...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      $message[] = 'Email hoặc số điẹn thoại đã tồn tại!';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="submit" value="Đăng ký ngay" name="submit" class="btnz">
      <p>Bạn chưa có tài khoản? <a style="text-decoration: none;" href="dangnhap">Đăng nhập ngay</a></p>
   </form>
